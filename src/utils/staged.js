...
const STAGES = Object.freeze({
  ...
  approval: '🔐 <b>Needs your approval…</b>',
...
// Words that signal real work (an action / write / plan / wait / multi-step).
const COMPLEX_RE = /\b(create|open|make|add|remove|delete|close|merge|update|edit|change|rename|schedule|remind|every|daily|weekly|audit|review|analy[sz]e|generate|build|deploy|release|push|commit|comment|label|assign|approve|watch|monitor|track|poll|wait|until|compare|report|summari[sz]e|fetch|scrape|check .* (repo|issue|pr|market|trend)|profile readme|transfer|archive|visibility|collaborator)\b/i;
